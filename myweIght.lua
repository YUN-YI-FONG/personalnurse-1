...
local statusBox = display.newRect( 40, 60, display.contentWidth-80, 70 )
	...
	-- Status text
	local statusText = display.newText( "體重 Value:000", 80, 350, 200, 0, native.systemFont, 14 )
...
statusText.text = "體重  Value: " .. values[1].value ..values[2].value .."."..values[3].value 
----------------------------------------------------------------------------------------------------------------------------------------------------------------	
local currentmyweIght = tonumber(values[1].value) *10 + tonumber(values[2].value)*1 + tonumber(values[3].value)*0.1
print("currentScore valus is =".. currentmyweIght)

infoTable.myweIght= currentmyweIght                            
print("infoTable.myweIght= "..infoTable.myweIght)   
---------------------------------------------------------------------------------------------------------------------------------------------------------------	 
