...
local statusBox = display.newRect( 40, 60, display.contentWidth-80, 70 )
	...
	-- Status text
	local statusText = display.newText( "年齡 Value:000", 80, 350, 200, 0, native.systemFont, 14 )
...
statusText.text = "年齡 Value: " .. values[1].value ..values[2].value ..values[3].value 
--------------------------------------------------------------------------------	
local currentsetage = tonumber(values[1].value) *100 + tonumber(values[2].value)*10 + tonumber(values[3].value)
print("currentScore valus is =".. currentsetage)

infoTable.setage= currentsetage                             
print("infoTable.setage= "..infoTable.setage)   
-------------------------------------------------------------------------------   
	return true
end
