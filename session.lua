...
local statusBox = display.newRect( 40, 60, display.contentWidth-80, 70 )
	...
	-- Status text
	local statusText = display.newText( "時間 Value:", 80, 350, 200, 0, native.systemFont, 14 )
...
infoTable.session= currentsession                            
print("infoTable.session= "..infoTable.session)   
-------------------------------------------------------------------------------   
