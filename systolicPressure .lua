...
local statusBox = display.newRect( 40, 60, display.contentWidth-80, 70 )
	...
	-- Status text
	local statusText = display.newText( "收縮壓   Value:000", 80, 350, 200, 0, native.systemFont, 14 )
...
statusText.text = "收縮壓  Value: " .. values[1].value ..values[2].value ..values[3].value 
--------------------------------------------------------------------------------	
local currentsystolicPressure = tonumber(values[1].value) *100 + tonumber(values[2].value)*10 + tonumber(values[3].value)
print("currentScore valus is =".. currentsystolicPressure)

infoTable.systolicPressure= currentsystolicPressure                                
print("infoTable1.systolicPressure= "..infoTable.systolicPressure)   
-------------------------------------------------------------------------------   	
		return true
	end
...
function scene:destroy( event )
	...
	print( "((destroying systolicPressure view))" )
end
