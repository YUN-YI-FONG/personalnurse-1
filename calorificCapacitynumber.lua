...
local statusBox = display.newRect( 40, 60, display.contentWidth-80, 70 )
	...
	-- Status text
	local statusText = display.newText( "calorificCapacity 1 Value:00000", 80, 350, 200, 0, native.systemFont, 14 )
...
statusText.text = "calorificCapacity 1 Value: " .. values[1].value ..values[2].value ..values[3].value ..values[4].value..values[5].value
global.calorificCapacitynumber = tonumber(values[1].value) *1000 + tonumber(values[2].value)*100 + tonumber(values[3].value)*10+ tonumber(values[4].value)*1+ tonumber(values[5].value)*0.1
  
  
   print(string.format("global.calorificCapacitynumber = %.2f",global.calorificCapacitynumber ))
